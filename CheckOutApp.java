...
public class CheckOutApp{
	...
	public static void main(String[] args){
		...
		purchasedItem(itemList, itemBought, perUnit, quantity);
			addMoreItem();
		

       }
		public static void purchasedItem(List<Item> itemList, String itemBought, double price, int quantity){
		...
		String myChashierName = input.nextLine();

		setCashierName(myChashierName);
		...
		System.out.println("=============================================================");
		System.out.println("THIS IS NOT A RECEIPET KINDLY PAY " + totalBill());
		System.out.println("=============================================================");
