...
class AccountTest(unittest.TestCase):
    ...
    def setUp(self):
        self.account = Account("Banjo Solomon", "correct_pin", "balance")
    ...
    def test_account_number(self):
        check_account = Account("Banjo Solomon", "correct_pin", "10_000")
        account_number = check_account.get_account_number()
        self.assertEqual(1, account_number)

    def test_account_can_deposit(self):
        my_account = Account("Banjo Solomon", "correct_pin", "10_000")
    ...
    def test_account_can_withdraw(self):
        my_account = Account("UBA", "correct_pin", "10_000")
        initial_balance = 10_000
