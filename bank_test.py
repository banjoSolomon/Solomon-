...
class TestBankApp(unittest.TestCase):
    def setUp(self):
        self.bank = MyBank()
        self.account = Account("UBA", "correct_pin", "10_000")
        self.account_sending = Account("Banjo Solomon", "correct_pin", "10_000")
        self.account_receiving = Account("Sam Kelly", "correct_pin", "5_000")
    ...
    def test_account_are_in_a_list(self):
        account = Account("UBA", "correct_pin", "10_000")
    ...
    def test_bank_can_transfer(self):
        ...
        self.assertEqual(expected_sender_balance, self.account_sending.get_balance())
    ...
    def test_remove_account(self):
        solomon_account = Account("SolomonAccount", "correct_pin", "10_000")
    ...
    def test_to_find_account(self):
        kim_account = Account("KimAccount", "correct_pin", "10_000")
    ...
    def test_for_withdraw(self):
        my_account = Account("myAccount", "correct_pin", "10_000")
